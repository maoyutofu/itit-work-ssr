...
use crate::{FRIENDS_JSON, util::get_items};

#[component]
pub fn Footer() -> impl IntoView {
    let friends = get_items(FRIENDS_JSON);
    view! {
        <section class="my-5">
            <h2>友情连接</h2>
            <div class="mt-5 px-5 py-5 bg-white">
                <ul class="flex flex-wrap items-center gap-6 list-disc list-inside text-sm">
                    {
                        friends.into_iter().map(|item| view! {
        ...
        <div class="flex gap-2">
            ...
            <div class="text-sm">
                <a class="vp-repo-link" href="https://github.com/maoyutofu/itit-work-ssr" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
